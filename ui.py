...
class UI():
    ...
    def ask(self, question):
        ...
        pygame.font.init()
        current_str_un = []
        self.display_box( question + ": " + self.str.join(current_str_un))
        running = True
        while running:
            inkey = self.get_key()
...
"""
    def login(self):
        self.render_background()
        font = pygame.font.SysFont('arial', 30)
        line = font.render("Welcome To NR320", True, (255,255,255))
        self.parent_screen.blit(line, (200, 350))
        self.display_box("UserName : ")
        pygame.display.flip()
